...
<html lang="en">
    ...
    <body id="LRP_Website" data-spy="scroll" data-target=".navbar" data-offset="60">
        ...
        <!-- Container (Property Available Section) -->
        <div id="available-property">
            <div class="container">
                <h2 class="text-center">Rumah yang Tersedia</h2>
                <div class="row">
        ...
        <!-- Container (Latest Project Section) -->
        <div id="latest-project">
            <div class="text-center">
                <h2 class="title-last">Project Terkini</h2>
            </div>
            ...
            <div id="btm-section" class="container-fluid">
                <div class="row">
                    <div class="col-sm-3"></div>
                    <div class="col-sm-6">
                        <div class="row">
                            <div class="col-sm-8">
                                <h4 class="text-right">AKSDOADOS</h4>
                                <br>
                                <p>'m a paragraph. Click here to add your own text and edit me. It’s easy. Just click “Edit Text” or double click me to add your own content and make changes to the font. I’m a great place for you to tell a story and let your users know a little more about you.</p>
                            </div>
                            <div class="col-sm-4">
            ...
            <div class="container text-center">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <h4>Lokasi yang memuaskan</h4>
                        <p>"It’s easy. Just click “Edit Text” or double click me to add"<p>
                    </div>
                    <div class="col-sm-4">
                        <span class="glyphicon glyphicon-heart logo-small"></span>
                        <h4>Harga yang Tepat</h4>
                        <p>"It’s easy. Just click “Edit Text” or double click me to add"<p>
                    </div>
                    <div class="col-sm-4">
                        <span class="glyphicon glyphicon-certificate logo-small"></span>
                        <h4>Testimoni Masyarakat</h4>
                        <p>"It’s easy. Just click “Edit Text” or double click me to add"<p>
                    </div>
                </div>
            </div>      
